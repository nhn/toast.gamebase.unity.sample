    ...
    public static class GamebaseLog
    {
        ...
        private static string MakeLog(object message, object classObj, string methodName)
        {
            if (string.IsNullOrEmpty(message.ToString().Trim())
                || classObj is null
                || string.IsNullOrEmpty(methodName.Trim()))
            {
        ...
        /// 3. 데이터와 관련된 로그 표시
        /// </summary>
        public static void Debug(object message, object classObj, [CallerMemberName] string methodName = "")
        {
            if (isDebugLog == false)
            {
                return;
        ...
        /// </summary>
        public static void Warn(object message, object classObj, [CallerMemberName] string methodName = "")
        {
        ...
        /// </summary>
        public static void Error(object message, object classObj, [CallerMemberName] string methodName = "")
        {
            string log = MakeLog(message, classObj, methodName);
